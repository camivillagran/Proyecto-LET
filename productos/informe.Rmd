...
Al unir esta información con la base de datos, se obtuvo que hay comunas que no son consideradas, en esta muestra. Estas son: Tiltil, San José de Maipo, Alhué, Buin, Calera de Tango, Curacaví, El Monte, Isla de Maipo, María Pinto, Melipilla, Paine, Peñaflor, San Pedro, Talagante. Se puede notar que, en su mayoría, son del distrito 14. Esto se debe a que, como ya fue mencionado anteriormente, la base de datos contiene la información de aquellas comunas que sí lograron ser geocodifadas, dejando afuera comunas más rurales como lo son en su mayoría las del distrito 14.
...
De esté gráfico se puede concluir que las tres comunas que poseen mayor cantidad de atropellos son: Puente Alto, Maipú y Santiago. Por su parte, las que tienen una menor cantidad son Pirque, Lampa y Lo Espejo.
...
Según lo observado, se puede notar que las comunas que poseen mayor cantidad de fallecidos son Maipú, Santiago y La Florida. Además, se puede notar que existen varias comunas sin ningún fallecido.
...
De los gráficos anteriores se puede concluir que el distrito 10, presenta la mayor cantidad de lesionados leves y graves. Si no se tomara en cuenta el distrito 14, debido a esta muestra no considera la totalidad de los siniestros, se infiere que entre los distrito 11 y 13 son los que contienen menos lesionados.
...
Se puede observar que nuevamente es el distrito 10 quien posee una mayor cantidad de atropellos. Sin embargo, el distrito 8 es el que tiene más fallecidos producto de los accidentes.
...
De este gráfico se concluye que la intersección que presenta una mayor cantidad de atropellos en la Región Metropolitana es Avenida 5 de abril con Los Pajaritos, ubicada en la comuna de Maipú. Cabe recordar que está es la segunda comuna con más atropellos de la Región Metropolitana, como fue visto anteriormente.

## IV. Conclusión

A través del análisis estadístico realizado se puede deducir que, las comunas que presentan la mayor cantidad de atropellos en la Región Metropolitana son Puente Alto, Maipú y Santiago. Al mismo tiempo, si consideramos los fallecidos por comunas, se puede observar que Maipú es la comuna que posee la mayor cifra, seguido de Santiago y La Florida.

Además, considerando los distritos, ya mencionados anteriormente, se puede concluir que es el distrito 10 el que más lesionados leves y graves tiene, mientras que es el distrito 8 el que presenta una mayor cantidad de lesionados menos graves. Observando respecto a la cantidad de atropellos por distritos se puede notar que es el 10 quien presenta una mayor cantidad. De igual manera, si observamos los distritos respecto a la cantidad de fallecidos, se tiene que es el distrito 8 quien contiene la mayor cifra. Se puede observar que no existe ningún tipo de relación entre la cantidad de atropellos y fallecidos, debido a que el distrito con mayor cantidad atropellos no es el mismo distrito con la cifra más alta de fallecidos, incluso podemos notar que el distrito 8 aproximadamente tiene como 13 fallecidos durante el 2018, cuya cifra es muy baja a los casi 500 atropellos. 

Para finalizar, la intersección de calles que posee una mayor cantidad de accidentes es 5 de abril con Los Pajaritos, cuyo cruce esta ubicado en la comuna de Maipú, comuna que como ya fue mencionada, contiene
una cantidad preocupante de atropellos y fallecidos. Por lo cual a través de esta información se podrían tomar muchas decisiones para poder disminuir estas cifras. Por ejemplo, ir a terreno y hacer un estudio para identificar los factores que producen siniestros de transito en las diferentes comunas.
