...
Los siniestros de tránsito cada día son más frecuentes. Por lo que, en este informe se busca ver patrones que existen sobre estos en la Región Metropolitana a través de un análisis estadístico. Los datos utilizados poseen información sobre comunas, accidentes y tipos de lesiones. Los resultados obtenidos presentan la cantidad de accidentes y fallecidos por comunas. Al mismo tiempo, se agruparon las comunas en función de sus distritos correspondientes para inferir información a partir de ellos. A partir de estos resultados se pueden tomar decisiones para una educación vial más responsable.
...
De esté gráfico se aprecia que que las tres comunas que poseen mayor cantidad de atropellos son: Puente Alto, Maipú y Santiago. Por su parte, las que tienen una menor cantidad son Pirque, Lampa y Lo Espejo.
