...
Además, considerando los distritos, ya mencionados anteriormente, se puede concluir que es el distrito 10 el que más lesionados leves y graves tiene, mientras que es el distrito 8 el que presenta una mayor cantidad de lesionados menos graves. Observando respecto a la cantidad de atropellos por distritos se puede notar que es el 10 quien presenta una mayor cantidad. De igual manera, si observamos los distritos respecto a la cantidad de fallecidos, se tiene que es el distrito 8 quien contiene la mayor cifra.
...
una cantidad preocupante de atropellos y fallecidos. Por lo cual a través de esta información se podrían tomar muchas decisiones para poder disminuir estas cifras. Por ejemplo, ir a terreno y hacer un análisis para identificar los factores que producen siniestros de transito en las diferentes comunas.
